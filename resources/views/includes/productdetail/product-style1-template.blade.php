        ...
        <div class="row">
          <div class="col-12 col-md-12">
            ...
            <div class="pro-counter">
              ...
              <button type="button" class="btn btn-secondary btn-lg swipe-to-top add-to-cart">เพิ่มในตะกร้า</button>
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                  <div class="nav nav-pills" role="tablist">
                    <a class="nav-link nav-item  active" href="#description" id="description-tab" data-toggle="pill" role="tab">รายละเอียดสินค้า</a>
                    {{-- <a class="nav-link nav-item " href="#additionalInfo" id="additional-info-tab" data-toggle="pill" role="tab">Additional information</a> --}}
                    <a class="nav-link nav-item" href="#review" id="review-tab" data-toggle="pill" role="tab">รีวิว</a>
                  </div>
                        ...
                        <div class="write-review">
                          ...
                          <div class="write-review-box">
                            <div class="from-group row mb-3">
                              <div class="col-12"> <label for="inlineFormInputGroup2">ระดับ</label></div>
                            ...
                            <div class="from-group row mb-3">
                              <div class="col-12"> <label for="comment">รายละเอียด</label></div>
                              <div class="input-group col-12">

                                <textarea class="form-control" id="comment" placeholder="รายละเอียด"></textarea>
                                <div class="invalid-feedback"></div>
                              </div>
                            </div>
                            <div class="from-group">
                              <button type="button" class="btn btn-secondary swipe-to-top" onclick="productReview()">ตกลง</button>
