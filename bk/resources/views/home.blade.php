...
@section('content')
    ...
    {{-- <?php echo"<pre>";print_r(homePageBuilderJson());?> --}}
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            var url = "{{ url('') }}" +
                '/api/client/products?limit=8&page=1&getDetail=1&language_id=' + languageId +
                '&productCategories=1&sortBy=id&sortType=DESC&currency=' + localStorage.getItem("currency");
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            ...
                            if (data.data[i].detail != null && data.data[i].detail != 'null' && data.data[i]
                                .detail != '') {
                                clone.querySelector(".product-card-name").innerHTML = '<span style="color:#494F69;font-weight: normal;">'+data.data[i].detail[0]
                                    .title;+'</span>'
                            ...
                            if (data.data[i].product_type == 'simple') {
                                if (data.data[i].product_discount_price == '' || data.data[i]
                                    ...
                                    clone.querySelector(".product-card-price").innerHTML = '<span style="color:red!important;text-decoration:none!important;">' +data.data[i].product_discount_price_symbol + '</span>'
                                     + '<span>' +data.data[i].product_price_symbol + '</span>';
                                }
                            } else {
                                // console.log(data.data[i],"variable price");
                            ...
                            if (appendTo == 'new-arrival' || appendTo == 'weekly-sale' || appendTo == 'product-all') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        const clone = templ.content.cloneNode(true);
                            // clone.querySelector(".news-blog-date").innerHTML = data.data[0].date;
                            // clone.querySelector(".news-blog-date").setAttribute('data-id', data.data[0]
                            //     .product_id);
                            clone.querySelector(".blog-url").setAttribute('href', '/blog-detail/' + data.data[0]
                                .slug);
                            // clone.querySelector(".read-more-url").setAttribute('href', '/blog-detail/' + data
                            //     .data[0].slug);
                                if (data.data[0].gallary != null && data.data[0].gallary != 'null' && data.data[0]
                                .gallary != '') {
                                if (data.data[0].gallary.detail != null && $.trim(data.data[0].gallary
                                        .detail) != '' && data.data[0].gallary.detail != 'null') {
                                    if (data.data[0].gallary.detail[2].gallary_path) {
                                        clone.querySelector(".news-blog-image").setAttribute('src', data.data[0]
                            ...
                            if (data.data[0].detail != null && $.trim(data.data[0].detail) != '' && data.data[0]
                                .detail != 'null') {
                                clone.querySelector(".news-blog-image").setAttribute('alt', data.data[0].detail[
                                    0].name);
                            }
                            // if (data.data[0].category != null && data.data[0].category != 'null' && $.trim(data
                            //         .data[0].category) != '') {
                            //     if (data.data[0].category.blog_detail != null && data.data[0].category
                            //         .blog_detail != 'null' && data.data[0].category.blog_detail != '') {
                            //         clone.querySelector(".news-blog-category").innerHTML = data.data[0].category
                            //             .blog_detail[0].name;
                            //     }
                            // }
                            if (data.data[0].detail != null && data.data[0].detail != 'null' && $.trim(data
                                    .data[0].detail) != '') {
                                clone.querySelector(".news-blog-name").innerHTML = data.data[0].detail[0].name;
                                clone.querySelector(".news-blog-desc").innerHTML = data.data[0].detail[0]
                                    .description;
                            }
